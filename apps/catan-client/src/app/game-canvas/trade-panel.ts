...
/**
 * Single trade hub: bank/harbor trade and player-to-player proposals in one
 * modal, plus accept / reject for an incoming offer. Replaces the three
 * separate trade forms of the old menu.
 */
@Component({
