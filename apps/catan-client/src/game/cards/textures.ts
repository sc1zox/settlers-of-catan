...
function drawRoadIcon(ctx: CanvasRenderingContext2D, cx: number, cy: number, size: number): void {
...
function drawCrownIcon(ctx: CanvasRenderingContext2D, cx: number, cy: number, size: number): void {
  // Crown
