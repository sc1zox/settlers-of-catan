...
import { buildNamePlateTexture, buildSmileyCanvasTexture } from './avatar-textures';
...
export class AvatarSeat {
  ...
  public setDisplayName(name: string): void {
    ...
    this.namePlateTexture = buildNamePlateTexture(normalized, this.namePlateColor);
  ...
  private applySmileyPlaceholder(): void {
    if (this.smileyTexture === null) {
      this.smileyTexture = buildSmileyCanvasTexture();
    }
